...
<html>
 ...
 <!-- We want localisations: -->
 <script src="scripts/locale-nb_NO.js"></script>

 </head>
 <body>

<textarea id="textInput" class="input">Hun pleide alltid og kjøre i utkant strøk.
Vi nøyer oss ikke med tegnsetting

Det er både bra å dårlig.</textarea>

<p>Demo av Kaldera nynorsk grammatikkontroll.</p>

<p>Skriv noe, trykk «Sjekk grammatikken», klikk på grønne streker for å se på feilen eller få rettingsforslag. Trykk «Rediger» igjen for å skrive mer.</p>
